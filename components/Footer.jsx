...
export default function Footer() {
  return (
    <footer className="bg-white border-t border-gray-200  text-gray-600 text-sm font-mulish my-[64px] sm:pt-[64px] pt-[48px]">
      <div className="max-w-7xl mx-auto px-10 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6  text-[#2E343E] font-normal text-[16px]">
          <div>
            Contact us:{' '}
          ...
          <div className="flex flex-col sm:flex-row justify-center sm:justify-start gap-2 sm:gap-4  sm:text-left text-[#5B5E5F] text-[16px]">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between text-xs text-[#84878A] gap-2 h-[29px]">
